export default function Page() {
    return (
        <main className="legal__markdown mx-auto flex flex-col gap-2 px-4 py-16 lg:w-1/2 [&>ul]:flex [&>ul]:list-disc [&>ul]:flex-col [&>ul]:gap-2">
            <h1 id="terms-and-conditions">Terms and conditions</h1>
            <p>Last updated: April 25, 2025</p>
            <h2 id="agreement-to-our-legal-terms">
            ...
            <p>
                ...
                after the date such revised Legal Terms are posted. The Services
                are intended for users who are at least 18 years old. Persons
                under the age of 18 are not permitted to use or register for the
                Services. We recommend that you print a copy of these Legal
            ...
            <p>
                ...
                extent local laws are applicable. The Services are not tailored
                ...
                would be subjected to such laws, you may not use the Services.
            ...
            <h3 id="your-submissions-and-contributions">
            ...
            <h2 id="5-purchases-and-payment">5. PURCHASES AND PAYMENT</h2>
            ...
            <ul>
                ...
                <li>RuPay</li>
                <li>
                    BHIM UPI You agree to provide current, complete, and
                    ...
                    payments shall be in US dollars. You agree to pay all
                    ...
                    the same payment method, and/or orders that use the same
                    billing or shipping address. We reserve the right to limit
                    or prohibit orders that, in our sole judgment, appear to be
                    placed by dealers, resellers, or distributors.
                </li>
            </ul>
            <h2 id="6-subscriptions">6. SUBSCRIPTIONS</h2>
            <h3 id="billing-and-renewal">Billing and Renewal</h3>
            <p>
            ...
            <p>
                ...
                (&quot;EULA&quot;), the terms of the EULA will govern your use
                ...
                or non-infringement. You accept any and all risk arising out of
            ...
            <h2 id="9-user-generated-contributions">
            ...
            <h2 id="10-contribution-license">10. CONTRIBUTION LICENSE</h2>
            <p>
                ...
                absolute discretion, (1) to edit, redact, or otherwise change
                any Contributions; (2) to re-categorize any Contributions to
            ...
            <h2 id="11-social-media">11. SOCIAL MEDIA</h2>
            <p>
                ...
                grant us access to your Third-Party Account, without breach by
                you of any of the terms and conditions that govern your use of
                the applicable Third-Party Account, and without obligating us to
                ...
                the Services and your Third-Party Accounts at any time. PLEASE
            ...
            <h2 id="12-third-party-websites-and-content">
            ...
            <h2 id="13-services-management">13. SERVICES MANAGEMENT</h2>
            <p>
            ...
            <h2 id="14-privacy-policy">14. PRIVACY POLICY</h2>
            <p>
                ...
                advised the Services are hosted in India, United States, France
                and Japan. If you access the Services from any other region of
                ...
                laws in India, United States, France and Japan, then through
                your continued use of the Services, you are transferring your
                data to India, United States, France and Japan, and you
                expressly consent to have your data transferred to and processed
                in India, United States, France and Japan.
            </p>
            <h2 id="15-term-and-termination">15. TERM AND TERMINATION</h2>
            <p>
            ...
            <h2 id="16-modifications-and-interruptions">
            ...
            <h2 id="18-dispute-resolution">18. DISPUTE RESOLUTION</h2>
            ...
            <p>
                ...
                place, or arbitration shall be Kolkata, India. The language of
                the proceedings shall be English. The governing law of these
            ...
            <h2 id="19-corrections">19. CORRECTIONS</h2>
            <p>
            ...
            <h2 id="20-disclaimer">20. DISCLAIMER</h2>
            <p>
            ...
            <h2 id="21-limitations-of-liability">
            ...
            <h2 id="22-indemnification">22. INDEMNIFICATION</h2>
            <p>
            ...
            <h2 id="23-user-data">23. USER DATA</h2>
            <p>
            ...
            <h2 id="24-electronic-communications-transactions-and-signatures">
            ...
            <h2 id="25-california-users-and-residents">
            ...
            <h2 id="26-miscellaneous">26. MISCELLANEOUS</h2>
            <p>
            ...
            <h2 id="27-contact-us">27. CONTACT US</h2>
            <p>
