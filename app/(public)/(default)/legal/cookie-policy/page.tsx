    ...
    return (
        <main className="legal__markdown mx-auto flex flex-col gap-2 px-4 py-16 lg:w-1/2 [&>ul]:flex [&>ul]:list-disc [&>ul]:flex-col [&>ul]:gap-2">
            ...
            <p>
                ...
                web browser controls to accept or refuse cookies. The specific
            ...
            <p>Name: __cf_bm</p>
            <p>
                Purpose: Cloudflare places the cookie on end-user devices that
                access customer sites protected by Bot Management or Bot Fight
                Mode.
            </p>
            <p>Provider: .clerk.budgetbee.site</p>
            <p>
                Service: CloudFlare{" "}
            ...
            <p>Expires in: 29 minutes</p>

            <h3 id="performance-and-functionality-cookies-">
            ...
            <p>Name: _cfuvid</p>
            <p>
                Purpose: This cookie is set by Cloudflare to enhance security
                and performance. It helps identify trusted web traffic and
                ensures a secure browsing experience for users.
            </p>
            <p>Provider: .clerk.budgetbee.site</p>
            <p>
                Service: Cloudflare{" "}
            ...
            <h3 id="unclassified-cookies-">Unclassified cookies:</h3>
            <p>
            ...
            <hr />
            <p>Name: __client_uat_byCMC4Mn</p>
            <p>Provider: .budgetbee.site</p>
            <p>Type: server_cookie</p>
            <p>Expires in: 9 years 11 months 28 days</p>
            <hr />
            <p>Name: __client_uat</p>
            <p>Provider: .budgetbee.site</p>
            <p>Type: server_cookie</p>
            <p>Expires in: 9 years 11 months 28 days</p>
            <hr />
            ...
            <p>Expires in: 9 years 11 months 28 days</p>
            <hr />
            <p>Name: __clerk_environment</p>
            <p>Provider: www.budgetbee.site</p>
            <p>Type: html_local_storage</p>
            <p>Expires in: persistent</p>
            <hr />
            <h2 id="how-can-i-control-cookies-on-my-browser-">
            ...
            <p>
                ...
                <a href="mailto:samyabratamaji334@gmail.com">samyabratamaji334@gmail.com</a> or
                by post to:
            </p>
            <p>Budgetbee</p>
