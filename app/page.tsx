        ...
        <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
            ...
            <div className="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
              {/* <div className="w-full sm:w-auto">
                ...
                <input
                  ...
                  id="hero-input"
                  name="hero-input"
                  className="py-3 px-4 block w-full xl:min-w-72 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
              ...
              <Button size="lg" variant="ghost" className="text-lg w-fit">
                Learn more
              </Button>
            </div>
          ...
          <div className="lg:col-span-4 mt-10 lg:mt-0">
            ...
            <img
              ...
              src="/images/budgetbee.png"
              alt="Image Desc+ription"
            />
          </div>
        </div>
      </div>
