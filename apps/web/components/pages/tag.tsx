					...
					<div className="flex gap-4">
						{tagsQuery.data?.data.map(value => (
							<React.Fragment key={value.id}>
								<div className="border-input bg-background focus-visible:ring-ring inline-flex h-9 items-center justify-center gap-2 whitespace-nowrap rounded-md border px-4 py-2 text-sm font-medium shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50">
									<p>{value.name}</p>
