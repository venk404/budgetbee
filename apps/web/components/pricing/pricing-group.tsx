...
export function PricingSection() {
    return (
        <div
            ...
            <h1 className="text-accent-foreground text-4xl lg:text-5xl select-none font-[Instrument_Serif]">One <span className="text-primary">{" "}pricing{" "}</span> to rule them all.</h1>
            <PricingCardGroup />
        </div>
    );
}
