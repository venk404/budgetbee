                ...
                <form
                    ...
                    <div className="mt-4 flex w-full flex-wrap gap-2">
                                    ...
                                    >
                                        <Tooltip delayDuration={750}>
                                            <TooltipTrigger asChild>
                                                <Badge
                                                    variant="outline"
                                                    className="gap-1.5 rounded-full cursor-pointer select-none">
                                                    {value || "Currency"}
                                                </Badge>
                                            </TooltipTrigger>
                                            <TooltipContent side="bottom" className="p-2 border shadow-xl bg-accent">
                                                <div className="gap-2 flex items-center justify-center">
                                                    <p>Select currency</p>
                                                    <kbd
                                                        className="bg-muted/50 border/50 inline-flex items-center justify-center pointer-events-none select-none text-muted-foreground relative ml-auto rounded px-[0.3rem] py-[0.1rem] font-mono">
                                                        k
                                                    </kbd>
                                                </div>
                                            </TooltipContent>
                            ...
                            render={({ field: { value, onChange } }) => {
                                ...
                                return (
                                    <DatePicker
                                        ...
                                        date={date}
                                        open={datePickerOpen}
                                        onOpenChange={(e) => useStore.setState({ popover_datepicker_open: e })}
                        ...
                        <Controller
                            ...
                            control={control}
                            render={({ field: { value, onChange } }) => {
                                const status = value ?? "paid" as StatusBadgeProps["status"];
                                return (
                                    <React.Fragment>
                                        <StatusPicker
                                            value={status}
