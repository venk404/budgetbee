		...
		<main className="legal__markdown mx-auto flex flex-col gap-2 px-4 py-16 lg:w-1/2 [&>ul]:flex [&>ul]:list-disc [&>ul]:flex-col [&>ul]:gap-2">
			...
			<ul>
				...
				<li>
					...
					address your request to: samyabratamaji334@gmail.com. If we
			...
			<p>
				...
				change prices at any time. All payments shall be in Indian
				Rupees. You agree to pay all charges at the prices then in
