				...
				<CardContent>
					<form
						...
						<div className="space-y-2">
							<Label htmlFor="entry.608808182">
								Username (optional, for account identification)
							</Label>
							<Input
								name="entry.608808182"
								placeholder="Username"
							/>
						</div>
						<div className="space-y-2">
							<Label htmlFor="entry.1432853799">
								Email (optional, for account identification)
							</Label>
							<Input
								name="entry.1432853799"
								placeholder="Email"
								type="email"
							/>
						</div>
						<div className="space-y-2">
							<Label htmlFor="entry.1063352119">
								Describe the bug
							</Label>
							<Textarea
								name="entry.1063352119"
