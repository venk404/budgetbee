                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-muted/50">
                            <TableHead className="h-9 py-2 border-r">Key</TableHead>
                    ...
                    <TableBody>
                        {shortcuts.map((s, i) => (
                            <TableRow key={i}>
                                <TableCell className="py-2 font-medium border-r">{s.key}</TableCell>
                                <TableCell className="py-2">{s.action}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
